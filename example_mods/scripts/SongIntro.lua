--easy script configs
IntroTextSize = 32	--Size of the text for the Now Playing thing.
IntroSubTextSize = 37 --size of the text for the Song Name.
IntroTagColor = '#ff000020'	--Color of the tag at the end of the box.
IntroTagWidth = 29	--Width of the box's tag thingy.
--easy script configs
...
function onCreate()
	...
	makeGraphic('JukeBoxTag', 300+IntroTagWidth, 100, '#2DEAC9')
	setObjectCamera('JukeBoxTag', 'other')
	addLuaSprite('JukeBoxTag', true)

	--the box
	makeLuaSprite('JukeBox', 'empty', -305-IntroTagWidth, 15)
	makeGraphic('JukeBox', 300, 100, '#ff000020')
	setObjectCamera('JukeBox', 'other')
	addLuaSprite('JukeBox', true)
	
	--the text for the "Estas Reproduciendo" bit
	makeLuaText('JukeBoxText', 'Reproduciendo ', 300, -305- IntroTagWidth, 30)
	setTextAlignment('JukeBoxText', 'up')
	...
	setTextAlignment('JukeBoxSubText', 'up')
